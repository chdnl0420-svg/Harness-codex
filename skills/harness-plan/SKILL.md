...
- `Domain Contract` 는 `contract_id`, public contracts, invariants, commands/events, context relationships, contract examples 를 포함한다. 자세한 기준은 `skills/harness/docs/ddd-tdd-gates.md` 를 따른다.
...
- **Domain Contract** — contract_id 별 bounded context, ubiquitous language, public contracts, invariants, commands/events, context relationships, contract examples, missing contracts, implementation boundaries.
